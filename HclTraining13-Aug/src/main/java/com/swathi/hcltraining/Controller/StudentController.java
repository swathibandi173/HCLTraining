...
public class StudentController {
	...
	public List<Student> findByEmailAndAge(@PathVariable String email,@PathVariable Integer age){
		return studentService.findByEmailAndAge(email,age);
		
	}
	
	@GetMapping("/age/{age}")
	public List<Student> findByAgeLessThan(@PathVariable Integer age){
		return studentService.findByAgeLessThan(age);
		
	}
	
	@GetMapping("/stage/{startAge}/endage/{endAge}")
	public List<Student> findByAgeBetween(@PathVariable Integer startAge, @PathVariable Integer endAge){
